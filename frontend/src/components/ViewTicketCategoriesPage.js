...
// // // } from '@mui/material';
// // // import { ExpandLess, ExpandMore } from '@mui/icons-material';
// // // import DeleteCategoryDialog from './DeleteCategoryDialog'; // Import the dialog component
...
// // //     setCategoryIdToDelete(null); // Reset the category ID when dialog is closed
// // //   };
...
// // //                 onClick={() => handleDeleteClick(category._id)} // Open the delete dialog
// // //               >
// // //                 Delete
// // //               </Button>
// // //             </Box>
...
//               key={category._id}
//               sx={{
//                 backgroundColor: index % 2 === 0 ? '#7FA1C3' : '#BB9AB1', // Yellow and Blue
//                 borderRadius: '16px',
//                 padding: '16px',
//                 boxShadow: '0 2px 5px rgba(0,0,0,0.1)',
...
//               <Typography
//                 variant="body2"
//                 style={{ marginTop: '8px', fontStyle: 'italic', color: 'white' }}
//               >
//                 Created Date: {new Date(category.createdAt).toLocaleDateString()}
//               </Typography>
//               <Button
...
//                 to={`/admin/update-ticket/${category._id}`}
//                 variant="contained"
//                 color="success" // Green for update
//                 style={{ marginTop: '10px',backgroundColor: '#A8DF8E', // Custom green color for update
...
//                 style={{ marginLeft: '10px', marginTop: '10px' ,backgroundColor: '#FA7070', // Custom red color for delete
//                   color: 'white', // White text color
//                   fontWeight: 'bold',  }}
//                 onClick={() => setCategoryIdToDelete(category._id)}
//               >
